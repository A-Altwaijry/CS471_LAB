...
urlpatterns = [
 ...
 path('lab10/listbooks', views.list_books_part1, name='listbooks'),
 path('lab10/addbook', views.add_book, name='addbook'),
 path('lab10/editbook/<int:id>/', views.edit_book, name='editbook'),
 path('lab10/deletebook/<int:id>/', views.delete_book, name='deletebook'),
 path('lab11/listbooks', views.list_books_part2, name='listbooks_part2'),
 path('lab11/addbook', views.add_book_part2, name='addbook_part2'),
 path('lab11/editbook/<int:id>/', views.edit_book_part2, name='editbook_part2'),
 path('lab11/deletebook/<int:id>/', views.delete_book_part2, name='deletebook_part2'),
]
